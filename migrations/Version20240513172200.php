 ...
 */
final class Version20240513172200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, creator_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_232B318C7E3C61F9 (owner_id), INDEX IDX_232B318C61220EA6 (creator_id), UNIQUE INDEX UNIQ_IDENTIFIER_SLUG (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE protagonist (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, owner_id INT DEFAULT NULL, creator_id INT NOT NULL, portrait_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', story LONGTEXT DEFAULT NULL, INDEX IDX_200E1005E48FD905 (game_id), UNIQUE INDEX UNIQ_200E10057E3C61F9 (owner_id), INDEX IDX_200E100561220EA6 (creator_id), UNIQUE INDEX UNIQ_200E10051226EBF3 (portrait_id), UNIQUE INDEX UNIQ_IDENTIFIER_SLUG (slug, game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE upload (id INT AUTO_INCREMENT NOT NULL, uploader_id INT NOT NULL, name VARCHAR(255) NOT NULL, size INT NOT NULL, mime_type VARCHAR(255) NOT NULL, INDEX IDX_17BDE61F16678C77 (uploader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
