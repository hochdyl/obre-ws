 ...
 */
final class Version20240603164710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE protagonist_metric (id INT AUTO_INCREMENT NOT NULL, protagonist_id INT NOT NULL, metric_id INT NOT NULL, value INT NOT NULL, max INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3009F503CDF038AD (protagonist_id), INDEX IDX_3009F503A952D583 (metric_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
