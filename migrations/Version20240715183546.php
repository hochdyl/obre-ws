 ...
 */
final class Version20240715183546 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '1.0.0 - Users, Games, Protagonists, Metrics and Uploads';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE protagonist_metric (id INT AUTO_INCREMENT NOT NULL, protagonist_id INT NOT NULL, metric_details_id INT NOT NULL, value INT DEFAULT NULL, max INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3009F503CDF038AD (protagonist_id), INDEX IDX_3009F5039F1B5EF (metric_details_id), UNIQUE INDEX UNIQ_IDENTIFIER_METRIC (protagonist_id, metric_details_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
