 ...
 */
final class Version20240601222457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE metric (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, emoji VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE protagonist_metric (id INT AUTO_INCREMENT NOT NULL, protagonist_id INT NOT NULL, metric_id INT NOT NULL, value INT NOT NULL, max INT DEFAULT NULL, INDEX IDX_3009F503CDF038AD (protagonist_id), INDEX IDX_3009F503A952D583 (metric_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE protagonist_metric ADD CONSTRAINT FK_3009F503A952D583 FOREIGN KEY (metric_id) REFERENCES metric (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE protagonist_metric DROP FOREIGN KEY FK_3009F503A952D583');
